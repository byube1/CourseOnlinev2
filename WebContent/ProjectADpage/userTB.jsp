...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Dashboard -->
			<li class="nav-item "><a class="nav-link" href="../DashboardServlet">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow mx-1"><a
							...
							role="button" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <i class="far fa-bell fa-fw"></i> <!-- Counter - Alerts -->
						...
						<li class="nav-item dropdown no-arrow mx-1"><a
							...
							role="button" data-toggle="dropdown" aria-haspopup="true"
							aria-expanded="false"> <i class="far fa-envelope fa-fw"></i>
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"> <span
								class="mr-2 d-none d-lg-inline text-gray-600 small">Hello,${User.getName()}</span>
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">Hello, ${User.getName()}</h1>
					<p class="mb-4"></p>

					<!-- DataTales Example -->
					<div class="card shadow mb-4">
						<div class="card-header py-4  ">
							<h6 class="m-0 font-weight-bold text-primary d-inline">User
								information</h6>
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-hover" id="dataTable" width="100%"
									cellspacing="0">
									<c:set var="dataUser" scope="session" value="${ListUser}" />									
									<thead>
										<tr>
											<th>ID</th>
											<th>Email</th>
									...
									<tbody>
										<c:forEach var="User" items="${dataUser}">
											<tr>
												...
												<td>${User.getEmail()}</td>
												<td>${User.getName()}</td>
												<td>${User.getType()==1?"Admin":"User"}</td>
												<td>${User.getPhone()}</td>
