            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" class="form-control bg-light border-0 " placeholder="Search " aria-label="Search" aria-describedby="basic-addon2">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Hello, Admin</h1>
                        <p class="mb-4"></p>
                    ...
                    <form action="../ManageCourseServlet/add" method="get">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="" name="img" required>
                            </div>   
                            <div class="form-group">
                                <label for="exampleInputEmail1">Price</label>
                                <input type="number" class="form-control" id="" name="price" required>
                                <p style="text-align: center; color: red;">
                                    <%=(session.getAttribute("ErrPrice") == null) ? "" : session.getAttribute("ErrPrice")%></p>
                            </div>                                      
