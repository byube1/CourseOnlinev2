...
<html lang="en">
                    ...
                    <div class="bgform container py-5">
                        ...
                        <form class="row" action="../ManageUserServlet/update" method="get">
                            <input class="form-control" type="text" id="account-fn" 
                                   name="id" hidden="" required value="${DetailUser.getId()}">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="account-fn">Full name</label>
                                    <input class="form-control" type="text" id="account-fn" 
                                           name="name"  value="${DetailUser.getName()}" required>
                                    <p style="text-align: center; color: red;">
                                        <%=(session.getAttribute("ErrorName") == null) ? "" : session.getAttribute("ErrorName")%></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="account-phone" 
                                           name="phone" value="${DetailUser.getPhone()}" required>
                                    <%--Code java --%>
                                    <p style="text-align: center; color: red;">
                                        <%=(session.getAttribute("ErrorPhone") == null) ? "" : session.getAttribute("ErrorPhone")%></p>
                                        <%--Code java --%>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="account-pass" 
                                           name="pass" value="${DetailUser.getPass()}" required>
                                    <p style="text-align: center; color: red;">
                                        <%=(session.getAttribute("ErrorPass") == null) ? "" : session.getAttribute("ErrorPass")%></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" 
                                           id="account-pass" name="img" value="${DetailUser.getImg()}" required>
                                </div>
                            </div>
    ...
    <%session.removeValue("ErrorPhone");%>
    <%session.removeValue("ErrorName");%>
    <%session.removeValue("ErrorPass");%>
</html>